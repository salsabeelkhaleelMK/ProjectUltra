        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 lg:col-span-2">
          ...
          <div class="space-y-6">
            ...
            <div v-if="localSettings.dormantOpportunityEnabled" class="space-y-6 border-t border-gray-200 pt-6">
              ...
              <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-2">Conditions</h3>
                ...
                <ul class="text-xs text-gray-600 list-disc list-inside space-y-1 ml-2">
              ...
              <!-- Settings -->
              <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-4">Settings</h3>
                
                <!-- Time after last past appointment -->
                <div class="mb-6">
                  <label class="block text-sm font-medium text-gray-700 mb-2">Time after the last past appointment</label>
                  <p class="text-xs text-gray-500 mb-3">The system will start counting from the opportunity creation date for all those ones without appointments planned yet.</p>
                  <div class="flex items-center gap-3">
                    <div>
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Time after the last offer has been created/imported</label>
                  <div class="flex items-center gap-3">
                    <div>
                      <label class="block text-xs text-gray-500 mb-1">Days</label>
                      <input
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <div class="space-y-6 border-t border-gray-200 pt-6">
            ...
            <div v-if="localSettings.urgencyEnabled" class="space-y-6">
              <!-- Weight Sliders -->
              <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-2">Scoring Weights</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start justify-between mb-2">
                      <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                          <label class="text-sm font-medium text-gray-700">Intent Signals</label>
                          <span class="text-sm text-gray-600">{{ localSettings.urgencyWeights?.intent || 40 }}%</span>
                        </div>
                        <p class="text-xs text-gray-500">Measured by explicit actions: test drive requests, financing inquiries, trade-in value checks, dealer location searches, vehicle configuration activity</p>
                      </div>
                    </div>
                    <input
                      type="range"
                  ...
                  <div>
                    <div class="flex items-start justify-between mb-2">
                      <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                          <label class="text-sm font-medium text-gray-700">Behavioral Engagement</label>
                          <span class="text-sm text-gray-600">{{ localSettings.urgencyWeights?.behavioral || 35 }}%</span>
                        </div>
                        <p class="text-xs text-gray-500">Measured by digital interaction depth: time spent using configurator, number of return visits, downloaded brochures or financing materials, depth of features explored</p>
                      </div>
                    </div>
                    <input
                      type="range"
                  ...
                  <div>
                    <div class="flex items-start justify-between mb-2">
                      <div class="flex-1">
                        <div class="flex items-center gap-2 mb-1">
                          <label class="text-sm font-medium text-gray-700">Temporal Urgency</label>
                          <span class="text-sm text-gray-600">{{ localSettings.urgencyWeights?.temporal || 25 }}%</span>
                        </div>
                        <p class="text-xs text-gray-500">Measured by time-sensitive factors: lead freshness, weekend/evening submissions, approaching the 4th contact attempt, days since last contact</p>
                      </div>
                    </div>
                    <input
                      type="range"
              ...
              <!-- Threshold Inputs -->
              <div>
                <h3 class="text-sm font-semibold text-gray-800 mb-4">Urgency Level Thresholds</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">HOT (minimum score)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">WARM (minimum score)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">STANDARD (minimum score)</label>
                    <input
                      type="number"
