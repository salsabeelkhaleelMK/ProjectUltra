<template>
  <div v-if="task" class="flex-1 flex flex-col overflow-hidden lg:border-l border-gray-200">
    <EntityDetailLayout
      :task="task"
      :type="task.type"
  ...
  <div v-else class="hidden lg:flex flex-1 flex-col overflow-hidden lg:border-l border-gray-200">
