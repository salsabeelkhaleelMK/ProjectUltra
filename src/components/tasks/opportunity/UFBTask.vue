  ...
  >
    <template #actions>
      <button
        ...
        class="bg-red-600 hover:bg-red-700 text-white font-medium px-4 py-2 rounded-lg text-fluid-xs flex items-center gap-2 transition-colors shadow-sm shadow-gray-200"
      >
        Create Offer
      </button>
    </template>
