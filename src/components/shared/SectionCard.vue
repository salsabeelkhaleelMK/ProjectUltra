<template>
  <div class="bg-surface border border rounded-xl shadow-sm mb-6">
    <div class="p-4 border-b border bg-surfaceSecondary/50 flex justify-between items-center">
      <div class="flex items-center gap-2">
        <i v-if="icon" :class="[icon, 'text-sub text-xs']"></i>
