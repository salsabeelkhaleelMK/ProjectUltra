  ...
  >
    <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm text-gray-700">
            <li class="flex items-start gap-2">
              ...
              <span>Opportunity stage, probability, and expected close date</span>
            </li>
            <li class="flex items-start gap-2">
              <i class="fa-solid fa-minus text-red-500 text-xs mt-1"></i>
      ...
      <div class="p-6 border-t border-gray-200 flex justify-end gap-3">
        <button
          @click="$emit('cancel')"
          class="bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 font-medium px-4 py-2 rounded-lg text-sm transition-colors"
        >
          Cancel
        </button>
        <button
